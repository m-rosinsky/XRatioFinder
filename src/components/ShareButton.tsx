  ...
  return (
    <>
      <button
        ...
        className={`group relative flex items-center gap-2 px-4 py-2 rounded-full text-sm font-mono uppercase tracking-wide bg-white text-black transition-all hover:bg-white/90 hover:shadow-[0_0_15px_rgba(255,255,255,0.2)] ${className}`}
      >
